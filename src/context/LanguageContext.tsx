...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'guide.title': '关于',
    'guide.overview': '概述',
    'guide.overviewDesc': 'DocSeeker 是一款高效的本地文档全文搜索工具，基于 Electron + SQLite FTS5 + BM25 构建，支持 AND/OR/NOT/正则/前缀等多种搜索语法，按相关性排序。所有数据存储在本地，隐私安全。',
    'guide.formats': '支持的格式',
    ...
    'guide.feature5': '查重 + 缩略图预览：快速定位重复文件和内容',
  ...
  'en': {
    ...
    'guide.overviewDesc': 'DocSeeker is an efficient local full-text search tool built on Electron + SQLite FTS5 + BM25, supporting AND/OR/NOT/regex/prefix search with relevance ranking. All data stored locally for privacy.',
    ...
    'guide.feature5': 'Duplicate detection & thumbnails: Find duplicate files at a glance',

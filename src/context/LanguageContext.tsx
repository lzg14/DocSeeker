...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'search.filters': '过滤器','search.select': '选择','search.navigate': '定位','search.rightClick': '右键',
    ...
    'quote.extract': '提取卡片',
    'quote.title': '提取文献引用',
    'quote.enterKeyword': '请输入关键词',
    'quote.found': '找到 ',
    'quote.citations': ' 处引用',
    'quote.noResults': '未找到相关引用',
    'quote.copyAll': '复制全部',
    'quote.exportMd': '导出 MD',
    'quote.exportTxt': '导出 TXT',
    'quote.copy': '复制',
    'quote.copied': '已复制',
    'quote.line': '第',
    'quote.lineSuffix': '行',
    'quote.copyAllSuccess': '已复制全部到剪贴板',
    'quote.exportSuccess': '已保存到文件',
    'quote.exportFailed': '保存失败',
    // Context menu
    ...
    'guide.feature15': '文件类型筛选：可选择只扫描特定类型的文件，减少不必要的扫描',
    'guide.donate': '赞赏作者',
    ...
    'settings.doubleCtrl': '双击 Ctrl 唤起',
    'settings.doubleCtrlDesc': '连续快速按两下 Ctrl 键唤起搜索浮层',
    ...
    'settings.fileTypes.documents': '文档',
    'settings.fileTypes.pdf': 'PDF',
    'settings.fileTypes.text': '文本',
    'settings.fileTypes.odf': '开放文档',
  ...
  'en': {
    ...
    'search.filters': 'Filters','search.select': 'Select','search.navigate': 'Navigate','search.rightClick': 'Right-click',
    ...
    'search.fuzzy': 'Fuzzy',
    'search.fuzzyTip': 'Fuzzy search, tolerant of typos',
    ...
    'detail.line': '',
    // Quote cards
    'quote.extract': 'Extract Cards',
    'quote.title': 'Extract Citations',
    'quote.enterKeyword': 'Please enter a keyword',
    'quote.found': 'Found ',
    'quote.citations': ' citations',
    'quote.noResults': 'No citations found (min 50 chars before/after)',
    'quote.copyAll': 'Copy All',
    'quote.exportMd': 'Export MD',
    'quote.exportTxt': 'Export TXT',
    'quote.copy': 'Copy',
    'quote.copied': 'Copied!',
    'quote.line': 'Line ',
    'quote.lineSuffix': '',
    'quote.copyAllSuccess': 'Copied all to clipboard',
    'quote.exportSuccess': 'Saved to file',
    'quote.exportFailed': 'Save failed',
    // Context menu
    ...
    'guide.feature15': 'File Type Filter: Choose which file types to scan, reducing unnecessary processing',
    'guide.donate': 'Donate',
    ...
    'settings.doubleCtrl': 'Double-tap Ctrl',
    'settings.doubleCtrlDesc': 'Press Ctrl twice quickly to open the search popup',
    ...
    'settings.dataPath': 'Data Storage Location',
    ...
    'settings.fileTypes.documents': 'Documents',
    'settings.fileTypes.pdf': 'PDF',
    'settings.fileTypes.text': 'Text',
    'settings.fileTypes.odf': 'ODF',

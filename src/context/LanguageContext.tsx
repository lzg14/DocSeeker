...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'guide.feature5': '查重 + 缩略图预览：快速定位重复文件；鼠标悬停支持格式文件名前的 📷 可预览缩略图',
  ...
  'en': {
    ...
    'guide.feature5': 'Duplicate detection + thumbnail preview: Find duplicate files by hash; hover over filenames with 📷 to preview thumbnails',

...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'guide.feature12': '右键菜单导出文本：支持将文件内容导出为 TXT，对于扫描版 PDF 可快速提取文本',
    'guide.donate': '赞赏作者',
  ...
  'en': {
    ...
    'guide.feature12': 'Right-click Export Text: Export file content to TXT, quickly extract text from scanned PDFs',
    'guide.donate': 'Donate',

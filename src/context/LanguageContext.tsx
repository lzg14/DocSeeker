...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'guide.title': '关于',
    'guide.overview': '概述',
    'guide.overviewDesc': 'DocSeeker 是一款高效的本地文档全文搜索工具，基于 Electron + SQLite FTS5 + BM25 构建，支持 AND/OR/NOT/正则/前缀等多种搜索语法，按相关性排序。所有数据存储在本地，隐私安全。支持以下文档格式的全文索引与搜索：Word · Excel · PowerPoint · PDF · Text/MD/JSON/CSV · HTML · SVG · RTF · CHM · ODF · EPUB · ZIP · RAR · Email · WPS；并支持图片/音视频元数据全文索引（标题、歌手、GPS 等）。',
    'guide.formats': '支持的格式',
  ...
  'en': {
    ...
    'guide.overviewDesc': 'DocSeeker is an efficient local full-text search tool built on Electron + SQLite FTS5 + BM25, supporting AND/OR/NOT/regex/prefix search with relevance ranking. All data stored locally for privacy. Indexes and searches: Word · Excel · PowerPoint · PDF · Text/MD/JSON/CSV · HTML · SVG · RTF · CHM · ODF · EPUB · ZIP · RAR · Email · WPS; also indexes image/audio/video metadata (title, artist, GPS, etc.)',

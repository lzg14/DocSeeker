...
const translations: Record<Language, Record<string, string>> = {
  'zh-CN': {
    ...
    'guide.title': '关于',
    'guide.overview': '概述',
    'guide.overviewDesc': 'DocSeeker 是一款高效的本地文档全文搜索工具，基于 Electron + SQLite FTS5 + BM25 构建，支持 AND/OR/NOT/正则/前缀等多种搜索语法，按相关性排序。所有数据存储在本地，隐私安全。支持以下文档格式的全文索引与搜索：Word · Excel · PowerPoint · PDF · Text/MD/JSON/CSV · HTML · SVG · RTF · CHM · ODF · EPUB · ZIP · RAR · Email · WPS',
    'guide.formats': '支持的格式',

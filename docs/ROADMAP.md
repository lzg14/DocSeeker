...
> 更新时间: 2026-04-21（完成 M5.1 M5.2 M5.3 M5.4 M5.6 M5.7）
...
- [x] **M3.4** 云存储集成（OneDrive / Dropbox） — _天然支持，扫描本地云盘文件夹即可，无需额外配置_
...
- [x] **M5.1** 内容高亮跳转（点击搜索结果直接打开文件并定位到关键词位置） — ✅ 已完成（2026-04-21）
- [x] **M5.2** 搜索语法自动补全（输入时智能提示语法，减少学习成本） — ✅ 已完成（2026-04-21）
- [x] **M5.3** 搜索结果批量操作（移动/复制/删除多个结果） — ✅ 已完成（2026-04-21）
- [x] **M5.4** 右键资源管理器集成（"用 DocSeeker 搜索"右键菜单） — ✅ 已完成（2026-04-21）

...
- **图片 OCR**：可选启用图片文字识别，从 PNG/JPG/BMP/TIFF 等图片中提取文字内容，使图片中的文字也可被搜索（支持中文、英文、日文、韩文）。识别过程实时显示进度（当前第 X 张/共 N 张），完成后自动更新搜索索引
...
- 搜索结果按相关性排序
- 点击查看文件详情
- **文献引用卡片**：点击文件后可提取文档中的关键词引用（至少2个完整句子，前后各100字以上），支持复制、导出为 MD/TXT
- 快速打开文件或在文件夹中显示
